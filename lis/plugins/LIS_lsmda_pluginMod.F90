...
! Noah-MP.4.0.1 SMAP E OPL soil moisture
   ...
   call registerlsmdadiagnosevars(trim(LIS_noahmp401Id)//"+"//&
        trim(LIS_MOD10A1scfobsId)//char(0),noahmp401_snow_DAlog)
...
!#if 0    
   ...
   call registerlsmdadiagnosevars(trim(LIS_noahmp401Id)//"+"//&
        trim(LIS_AMSRcnnSnowobsId)//char(0),NoahMP401_snwd_DAlog)
#if 0
   ...
   call registerlsmdadiagnosevars(trim(LIS_noahmp401Id)//"+"//&
        trim(LIS_AMSRcnnSnowobsId)//char(0),NoahMP401_snow_DAlog)
#endif   
...
#if ( defined DA_OBS_MODISMLSWE)
   call registerlsmdainit(trim(LIS_noahmp401Id)//"+"//&
        trim(LIS_MODISMLsweobsId)//char(0),noahmp401_daswe_init)
   call registerlsmdagetstatevar(trim(LIS_noahmp401Id)//"+"//&
        trim(LIS_MODISMLsweobsId)//char(0),noahmp401_getswevars)
   call registerlsmdasetstatevar(trim(LIS_noahmp401Id)//"+"//&
        trim(LIS_MODISMLsweobsId)//char(0),noahmp401_setswevars)
   call registerlsmdagetobspred(trim(LIS_noahmp401Id)//"+"//&
        trim(LIS_MODISMLsweobsId)//char(0),noahmp401_getswepred)
   call registerlsmdaqcstate(trim(LIS_noahmp401Id)//"+"//&
        trim(LIS_MODISMLsweobsId)//char(0),noahmp401_qcswe)
   call registerlsmdaqcobsstate(trim(LIS_noahmp401Id)//"+"//&
        trim(LIS_MODISMLsweobsId)//char(0),noahmp401_qc_sweobs)
   call registerlsmdascalestatevar(trim(LIS_noahmp401Id)//"+"//&
        trim(LIS_MODISMLsweobsId)//char(0),noahmp401_scale_swe)
   call registerlsmdadescalestatevar(trim(LIS_noahmp401Id)//"+"//&
        trim(LIS_MODISMLsweobsId)//char(0),noahmp401_descale_swe)
   call registerlsmdaupdatestate(trim(LIS_noahmp401Id)//"+"//&
        trim(LIS_MODISMLsweobsId)//char(0),noahmp401_updateswevars)
   call registerlsmdaqcobsstate(trim(LIS_noahmp401Id)//"+"//&
        trim(LIS_MODISMLsweobsId)//char(0),noahmp401_qc_sweobs)
