...
!BOP
! 
! !ROUTINE: write_MODIS_MLSWE
! \label{write_MODIS_MLSWE}
! 
! !REVISION HISTORY: 
!  04 Jan 2024: Sujay Kumar; Initial version
! 
! !INTERFACE: 
subroutine write_MODIS_MLSWE(n, k, OBS_State)
! !USES: 
  use ESMF
  use LIS_coreMod
  use LIS_logMod
...
! MODIS_MLSWE observations a file
! 
!EOP
  ...
  if(data_update) then 
     ...
     if(LIS_masterproc) then 
        ...
        call MODIS_MLSWE_obsname(n,k,obsname)        
...
end subroutine write_MODIS_MLSWE

!BOP
! !ROUTINE: MODIS_MLSWE_obsname
! \label{MODIS_MLSWE_obsname}
! 
! !INTERFACE: 
subroutine MODIS_MLSWE_obsname(n,k,obsname)
! !USES: 
...
end subroutine MODIS_MLSWE_obsname
